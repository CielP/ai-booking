...
TBD — defines how the cancel booking action is presented and handled inline within the My Bookings page, including button visibility, confirmation flow, optimistic UI updates, and loading state management.
